...
def wordleSolver(possible_words):
    ...
    diff = (date.today() - date(2022, 8, 31)).days
    ...
    while result != "ggggg" and counter < 6:
        ...
        counter += 1
    if len(possible_words) == 0:
        print("Oh no! Our respense . . . Its broken. Please try again.")
    elif counter == 6 and result != "ggggg":
        print("Number of guesses exceeded, sorry we failed!")
    else:
        print("Congratulations! OUR ALGORITH OUT WORDLED THE NERDS IN ", counter, "guesses.")
